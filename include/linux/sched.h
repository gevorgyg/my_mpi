...
struct exec_domain;
/*Aviel edit  [32,39]*/
/* MPI message structure for message passing */
struct mpi_message {
...
/* journalling filesystem info */
	...
	/*Aviel edit [463,468]*/
	/* MPI fields */
	int mpi_registered;        /* did this process call mpi_register()? */
	int mpi_gid;               /* group ID */
	struct list_head mpi_queue; /* FIFO queue for incoming messages */
